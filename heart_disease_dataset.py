...
# Crear transformadores para preprocesar las variables
...
precision_0 = [0.83, 0.81, 0.87, 0.85]
recall_0 = [0.83, 0.90, 0.90, 0.79]
f1_score_0 = [0.83, 0.85, 0.88, 0.82]

# AUC-ROC
auc_roc = [0.92, 0.94, 0.93, 0.92]
